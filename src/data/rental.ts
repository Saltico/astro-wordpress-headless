...
import gruaDemag160t from '@/assets/imgs/rental/izaje/grua/grua-demag-ac160-5/grua-demag-ac160-5.avif';
import gruaGrove250t from '@/assets/imgs/rental/izaje/grua/grua-grove-gmk-5250l/grua-grove-gmk-5250l.avif';
import gruaGrove250tXL from '@/assets/imgs/rental/izaje/grua/grua-grove-gmk-5250xl-1/grua-grove-gmk-5250xl-1.avif';
import gruaGrove400t from '@/assets/imgs/rental/izaje/grua/grua-grove-gmk6400/grua-grove-gmk6400.avif';
import gruaTadanoGr1000xl from '@/assets/imgs/rental/izaje/grua/grua-tadano-gr1000xl/grua-tadano-gr1000xl.avif';
import gruaTadanoGr1200xl from '@/assets/imgs/rental/izaje/grua/grua-tadano-gr1200xl/grua-tadano-gr1200xl.avif';
import gruaTadanoGr1300xl from '@/assets/imgs/rental/izaje/grua/grua-tadano-gr1300xl/grua-tadano-gr1300xl.avif';
...
const GRUA_DEMAG_160T = gruaDemag160t.src;
const GRUA_GROVE_250T = gruaGrove250t.src;
const GRUA_GROVE_250T_XL = gruaGrove250tXL.src;
const GRUA_GROVE_400T = gruaGrove400t.src;
const GRUA_TADANO_GR1000XL = gruaTadanoGr1000xl.src;
const GRUA_TADANO_GR1200XL = gruaTadanoGr1200xl.src;
const GRUA_TADANO_GR1300XL = gruaTadanoGr1300xl.src;
...
const IZAJE_GRUAS_60: RentalSubcategory = {
  ...
  shortDesc: 'Grúas rough terrain de 60 t para izaje en minería, construcción e industria.',
  description:
    'Arriendo de grúas de 60 toneladas en Chile para proyectos de minería, construcción e industria. Grúas rough terrain y todo terreno (AT) con capacidades entre 55 y 65 toneladas, diseñadas para operar en terrenos difíciles y espacios reducidos. Equipos de marcas líderes como Grove con pluma MEGAFORM™ de hasta 33,5 m y extensiones que alcanzan alturas de hasta 65 metros. Operadores certificados con experiencia en faena, planes de izaje, permisos de trabajo y supervisión técnica incluidos. Disponibilidad en zona norte (Atacama, Coquimbo) y centro del país, con respuesta operativa en menos de 48 horas. Ideales para montaje de estructuras, izaje de equipos, apoyo a obras civiles y maniobras de precisión en minería.',
  features: [
    'Grúas rough terrain y todo terreno (AT) de 55 a 65 toneladas.',
    'Operadores certificados con experiencia en faenas mineras e industriales.',
  ...
  specs: [
    ...
    { label: 'Altura máxima', value: '40 – 65 m' },
    { label: 'Operador', value: 'Incluido' },
    { label: 'Disponibilidad', value: '24/7' },
  ],
  heroImage: IZAJE_HERO,
  bodyImage: GRUA_GROVE_60T,
  bodyImageAlt: 'Grúa Grove RT 765 E de 60 toneladas en faena minera',
  seoTitle: 'Arriendo de Grúas de 60 Toneladas en Chile',
  seoDescription:
    'Arriendo de grúas de 60 toneladas con operador certificado en Chile. Equipos Grove rough terrain. Hasta 65 m de altura. Solicite cotización online.',
  catalog: [
    {
      ...
      capacity: '60 t',
      height: '65 m',
      shortDesc: 'Grúa rough terrain de 60 t con pluma MEGAFORM™ de 33,5 m y extensión bi-fold de hasta 17,1 m. Motor Cummins Tier 4 Final, 4 modos de dirección y cabina de visión completa para máxima productividad en terrenos difíciles.',
      description: 'La Grove RT 765 E es una grúa rough terrain de 60 toneladas diseñada para ofrecer alto rendimiento en terrenos difíciles y espacios reducidos. Su pluma MEGAFORM™ de 4 secciones alcanza 33,5 m, y con la extensión bi-fold opcional puede llegar hasta 65,2 m de altura máxima de punta. Equipada con motor Cummins QSB 6.7L Tier 4 Final de 240 HP, ofrece potencia confiable y bajo consumo de combustible. Los 4 modos de dirección (incluyendo dirección en cangrejo) facilitan el posicionamiento preciso en faenas mineras, de construcción e industriales. La cabina de visión completa con sistema de calefacción y aire acondicionado garantiza comodidad del operador, mientras que el sistema de control de momento de carga con pantalla gráfica asegura operaciones seguras. Contrapeso de 6,5 t fijado a la superestructura y tracción de cable de 7.620 kg con velocidad de hasta 153 m/min para mayor eficiencia.',
      features: [
        'Pluma MEGAFORM™ de 4 secciones: 11 – 33,5 m.',
        'Extensión bi-fold de 10,1 – 17,1 m (altura máx. 65 m).',
        'Motor Cummins QSB 6.7L Tier 4 Final de 240 HP.',
        '4 modos de dirección para máxima maniobrabilidad.',
        'Cabina de visión completa con climatización.',
        'Sistema de control de momento de carga con pantalla gráfica.',
      ],
      specs: [
        { attribute: 'Capacidad máxima', value: '60 t' },
        { attribute: 'Pluma principal', value: '11 – 33,5 m (4 secciones MEGAFORM™)' },
        { attribute: 'Extensión bi-fold', value: '10,1 – 17,1 m' },
        { attribute: 'Altura máxima de punta', value: '65,2 m' },
        { attribute: 'Motor', value: 'Cummins QSB 6.7L Tier 4 Final, 6 cil. turbo' },
        { attribute: 'Potencia', value: '179 kW / 240 HP' },
        { attribute: 'Torque máximo', value: '990 Nm @ 1500 rpm' },
        { attribute: 'Contrapeso', value: '6,5 t' },
        { attribute: 'Peso bruto total', value: '42,6 t' },
        { attribute: 'Ejes', value: '4 ejes con 4 modos de dirección' },
        { attribute: 'Tracción de cable', value: '7.620 kg' },
        { attribute: 'Velocidad de cable', value: '153 m/min' },
        { attribute: 'Estabilizadores', value: '4 gatos hidráulicos invertidos' },
      ],
      image: GRUA_GROVE_60T,
      gallery: [GRUA_GROVE_60T, GRUA_GROVE_60T, GRUA_GROVE_60T],
      techSheetUrl: 'https://www.manitowoc.com/es/media/12113/download',
      ...
      seoTitle: 'Arriendo de Grúa Grove RT 765 E de 60 Toneladas en Chile',
      seoDescription: 'Arriende la grúa rough terrain Grove RT 765 E de 60 t con operador certificado. Pluma de 33,5 m, extensión bi-fold y motor Cummins Tier 4. Cotice online.',
    },
/*     {
...
const IZAJE_GRUAS_80: RentalSubcategory = {
  ...
  shortDesc: 'Grúas rough terrain de 72-80 t para izaje pesado en minería e industria.',
  description:
    'Arriendo de grúas de 80 toneladas (72.6 t métricos) en Chile para proyectos de gran envergadura en minería, construcción e industria. Grúas rough terrain con capacidades entre 72 y 80 toneladas y altura máxima de pluma de hasta 58 metros con jib swingaway. Equipos de marcas líderes como Terex con pluma telescópica de 4 secciones full-power, motor Cummins Tier 4F y tracción 4WD para terrenos difíciles. Operadores certificados con experiencia en faenas mineras, planes de izaje, permisos de trabajo y supervisión técnica incluidos. Disponibilidad en zona norte (Atacama, Coquimbo, Antofagasta) y centro del país, con respuesta operativa en menos de 48 horas. Servicio 24/7 con mantenimiento preventivo y seguros incluidos durante todo el período de arriendo.',
  features: [
    'Grúas rough terrain de 72 a 80 toneladas (US tons).',
  ...
  specs: [
    { label: 'Capacidad', value: '72 – 80 t' },
    { label: 'Altura máxima', value: '50 – 58 m' },
    { label: 'Operador', value: 'Incluido' },
    { label: 'Disponibilidad', value: '24/7' },
  ],
  heroImage: IZAJE_HERO,
  bodyImage: GRUA_TEREX_80T,
  bodyImageAlt: 'Grúa Terex RT 780 de 72.6 toneladas en faena minera',
  seoTitle: 'Arriendo de Grúas de 80 Toneladas en Chile',
  seoDescription:
    'Arriendo de grúas rough terrain de 72-80 toneladas con operador certificado en Chile. Equipos Terex con pluma de 38 m y jib swingaway. Hasta 58 m de altura. Solicite cotización.',
  catalog: [
    {
      ...
      capacity: '72.6 t',
      height: '58 m',
      shortDesc: 'Grúa rough terrain de 72.6 t con pluma telescópica de 38.3 m y jib swingaway de hasta 17.4 m. Motor Cummins QSB6.7 Tier 4F de 260 HP, transmisión 6x6 powershift y tracción 4WD para máximo rendimiento en terrenos difíciles.',
      description: 'La Terex RT 780 es una grúa rough terrain de 72.6 toneladas (80 US tons) diseñada para operaciones de izaje pesado en minería, construcción e industria. Su pluma telescópica de 4 secciones full-power alcanza 38.3 m, y con el jib swingaway opcional de 10 a 17.4 m logra una altura máxima de punta de 58 m. Equipada con motor Cummins QSB6.7 de 6 cilindros turboalimentado (260 HP Tier 4F o 275 HP Tier 3), transmisión powershift 6x6 con convertidor de par y tracción 4WD seleccionable, ofrece potencia y movilidad excepcionales en terrenos irregulares. El sistema de estabilizadores hidráulicos con extensión independiente y bloqueos de diferencial en ejes delantero y trasero garantizan estabilidad óptima. Cabina climatizada con sistema de control de momento de carga y limitador de carga electrónico para operaciones seguras. Contrapeso de 6.9 t y capacidad de izaje de 72.6 t a 3 m de radio.',
      features: [
        'Pluma telescópica de 4 secciones: 12.2 – 38.3 m.',
        'Jib swingaway de 10 – 17.4 m (altura máx. 58 m).',
        'Motor Cummins QSB6.7 Tier 4F de 260 HP.',
        'Transmisión powershift 6x6 con convertidor de par.',
        'Tracción 4WD seleccionable con bloqueo de diferencial.',
        'Estabilizadores hidráulicos con extensión independiente.',
        'Cabina climatizada con control de momento de carga.',
      ],
      specs: [
        { attribute: 'Capacidad máxima', value: '72.6 t @ 3 m de radio' },
        { attribute: 'Pluma principal', value: '12.2 – 38.3 m (4 secciones)' },
        { attribute: 'Jib swingaway', value: '10 – 17.4 m' },
        { attribute: 'Altura máxima de punta', value: '58 m' },
        { attribute: 'Motor', value: 'Cummins QSB6.7 Tier 4F, 6 cil. turbo' },
        { attribute: 'Potencia', value: '194 kW / 260 HP @ 2200 rpm' },
        { attribute: 'Torque máximo', value: '990 Nm @ 1500 rpm' },
        { attribute: 'Contrapeso', value: '6.9 t' },
        { attribute: 'Peso bruto total', value: '41.4 t' },
        { attribute: 'Transmisión', value: 'Powershift 6x6 con convertidor' },
        { attribute: 'Tracción', value: '4WD seleccionable' },
        { attribute: 'Ejes', value: '2 ejes (delantero rígido, trasero oscilante)' },
        { attribute: 'Frenos', value: 'Disco air-over-hydraulic' },
        { attribute: 'Ángulo de pluma', value: '-4° / +78°' },
        { attribute: 'Tanque de combustible', value: '303 L' },
      ],
      image: GRUA_TEREX_80T,
      gallery: [GRUA_TEREX_80T, GRUA_TEREX_80T, GRUA_TEREX_80T],
      // TODO: techSheetUrl pendiente - requiere solicitud por correo al fabricante
      // techSheetUrl: 'https://www.terex.com/docs/librariesprovider10/product-literature/rough-terrain/datasheet/rt-780-metric-datasheet-(en-fr-de-it-es-pt-ru).pdf',
      whatsappMessage: 'Hola IP, quisiera cotizar arriendo de Grúa Terex RT 780 (72.6 t).',
      relatedSlugs: ['grua-grove-rt-765-e', 'grua-grove-gmk-4100'],
      seoTitle: 'Arriendo de Grúa Terex RT 780 de 72.6 Toneladas en Chile',
      seoDescription: 'Arriende la grúa rough terrain Terex RT 780 de 72.6 t con operador certificado. Pluma de 38.3 m, jib swingaway y motor Cummins Tier 4F. Cotice online.',
    },
/*     {
...
const IZAJE_GRUAS_90: RentalSubcategory = {
  slug: 'gruas-90-toneladas',
  name: 'Grúas de 90 toneladas',
  shortDesc: 'Grúas rough terrain de 90 t para izaje pesado en minería, construcción e industria.',
  description:
    'Arriendo de grúas de 90 toneladas en Chile para proyectos de minería, construcción e industria. Grúas rough terrain con capacidades de 90 toneladas (100 US tons) y pluma telescópica de hasta 47 metros, extensible con plumín hasta 64.4 metros de altura. Equipos de marcas líderes como Tadano con motor Cummins, sistema de control avanzado y configuración de contrapeso inteligente para máximo radio de trabajo. Operadores certificados con experiencia en faenas mineras, planes de izaje, permisos de trabajo y supervisión técnica incluidos. Disponibilidad en zona norte (Atacama, Coquimbo) y centro del país, con respuesta operativa en menos de 48 horas. Servicio 24/7 con mantenimiento preventivo y seguros incluidos durante todo el período de arriendo.',
  features: [
    'Grúas rough terrain de 90 toneladas (100 US tons).',
    'Pluma telescópica de hasta 47 m + plumín (64.4 m total).',
    'Motor Cummins con reducción de emisiones y consumo.',
    'Sistema de supervisión avanzado y configuración de contrapeso inteligente.',
    'Operadores certificados con experiencia en faena minera.',
    'Planes de izaje, permisos de trabajo y supervisión técnica.',
    'Disponibilidad 24/7 y seguros incluidos.',
  ],
  specs: [
    { label: 'Capacidad', value: '90 t' },
    { label: 'Altura máxima', value: '47 – 64 m' },
    { label: 'Operador', value: 'Incluido' },
    { label: 'Disponibilidad', value: '24/7' },
  ],
  heroImage: IZAJE_HERO,
  bodyImage: GRUA_TADANO_GR1000XL,
  bodyImageAlt: 'Grúa Tadano GR-1000XL-4 de 90 toneladas en faena minera',
  seoTitle: 'Arriendo de Grúas de 90 Toneladas en Chile',
  seoDescription:
    'Arriendo de grúas rough terrain de 90 toneladas con operador certificado en Chile. Equipos Tadano con pluma de 47 m y altura de 64 m. Solicite cotización.',
  catalog: [
    {
      ...
      capacity: '90.7 t',
      height: '64.4 m',
      shortDesc: 'Grúa rough terrain de 90.7 t con pluma telescópica de 47 m y plumín de hasta 17.7 m. Motor Cummins con reducción de emisiones, sistema de supervisión avanzado y configuración de contrapeso inteligente para máximo radio de trabajo.',
      description: 'La Tadano GR-1000XL-4 es una grúa rough terrain de 90.7 toneladas (100 US tons) completamente rediseñada en 2020, equipada con motor Cummins que reduce emisiones y consumo de combustible. Su pluma telescópica de 2 secciones alcanza 47 m, y con extensiones de plumín de 10.1 m o 17.7 m logra una altura máxima de cabeza de pluma de 64.4 m. Como primicia mundial, esta grúa cuenta con una configuración de contrapeso inteligente que permite colocar el contrapeso en dos posiciones, potenciando considerablemente el radio de trabajo. Equipada con sistema de supervisión avanzado, extensión de estabilizadores maximizados (7.33 m x 7.3 m) y tiro de línea de elevación de 9,090 kg. Transmisión 4x4x4 con 2 ejes para máxima maniobrabilidad en terrenos difíciles. Ideal para minería, construcción e industria donde se requiere capacidad, alcance y precisión.',
      features: [
        'Pluma telescópica de 2 secciones: 12.0 – 47.0 m.',
        'Extensiones de plumín: 10.1 m / 17.7 m.',
        'Altura máxima de cabeza de pluma: 64.4 m.',
        'Motor Cummins con reducción de emisiones y consumo.',
        'Configuración de contrapeso inteligente (2 posiciones).',
        'Sistema de supervisión avanzado.',
        'Estabilizadores maximizados: 7.33 m x 7.3 m.',
      ],
      specs: [
        { attribute: 'Capacidad máxima', value: '90.7 t (100 US tons)' },
        { attribute: 'Pluma principal', value: '12.0 – 47.0 m (2 secciones)' },
        { attribute: 'Extensiones de plumín', value: '10.1 m / 17.7 m' },
        { attribute: 'Altura máxima de cabeza de pluma', value: '64.4 m' },
        { attribute: 'Radio máximo', value: '48.76 m' },
        { attribute: 'Base de estabilizadores', value: '7.33 m x 7.3 m' },
        { attribute: 'Tiro de línea de elevación', value: '9,090 kg' },
        { attribute: 'Motor', value: 'Cummins (reducción de emisiones)' },
        { attribute: 'Transmisión', value: '4x4x4' },
        { attribute: 'Ejes', value: '2 ejes' },
        { attribute: 'Dimensiones (L x W x H)', value: '14.37 m x 3.31 m x 3.80 m' },
      ],
      image: GRUA_TADANO_GR1000XL,
      gallery: [GRUA_TADANO_GR1000XL, GRUA_TADANO_GR1000XL, GRUA_TADANO_GR1000XL],
      techSheetUrl: 'https://assets.onetadano.com/celum_assets/documents/gr_1000xl-4_datasheet_metric_es.pdf',
      whatsappMessage: 'Hola IP, quisiera cotizar arriendo de Grúa Tadano GR-1000XL-4 (90.7 t).',
      relatedSlugs: ['grua-terex-rt-780-e', 'grua-grove-gmk-4100'],
      seoTitle: 'Arriendo de Grúa Tadano GR-1000XL-4 de 90.7 Toneladas en Chile',
      seoDescription: 'Arriende la grúa rough terrain Tadano GR-1000XL-4 de 90.7 t con operador certificado. Pluma de 47 m, altura de 64.4 m y motor Cummins. Cotice online.',
    },
  ],
  whatsappMessage: 'Hola IP, quisiera cotizar arriendo de grúas de 90 toneladas.',
};

const IZAJE_GRUAS_100: RentalSubcategory = {
  slug: 'gruas-100-toneladas',
  name: 'Grúas de 100 toneladas',
  shortDesc: 'Grúas rough terrain y AT de 100-118 t para izaje pesado en minería, refinerías e industria.',
  description:
    'Arriendo de grúas de 100 toneladas en Chile para proyectos de minería, refinerías e industria. Grúas rough terrain y todo terreno (AT) con capacidades entre 100 y 118 toneladas y altura máxima de pluma de hasta 73.57 metros con extensiones. Equipos de marcas líderes como Grove y Tadano con motores Cummins y Mercedes-Benz, sistemas de control avanzados (Smart Chart, MEGS) y configuración de contrapeso inteligente. Operadores certificados con experiencia en faenas mineras, refinerías y montajes industriales. Planes de izaje, permisos de trabajo y supervisión técnica incluidos. Disponibilidad en zona norte (Atacama, Coquimbo) y centro del país, con respuesta operativa en menos de 48 horas. Servicio 24/7 con mantenimiento preventivo y seguros incluidos durante todo el período de arriendo.',
  features: [
    'Grúas rough terrain y todo terreno (AT) de 100 a 118 toneladas.',
    'Pluma telescópica de hasta 56 m + extensiones (73.57 m total).',
    'Motores Cummins y Mercedes-Benz con reducción de emisiones.',
    'Sistemas de control avanzados (Smart Chart, MEGS) y contrapeso inteligente.',
    'Operadores certificados con experiencia en minería y refinerías.',
    'Planes de izaje, permisos de trabajo y supervisión técnica.',
    'Disponibilidad 24/7 y seguros incluidos.',
  ],
  specs: [
    { label: 'Capacidad', value: '100 – 118 t' },
    { label: 'Altura máxima', value: '60 – 73.57 m' },
    { label: 'Operador', value: 'Incluido' },
    { label: 'Disponibilidad', value: '24/7' },
  ],
  heroImage: IZAJE_HERO,
  ...
  seoTitle: 'Arriendo de Grúas de 100 Toneladas en Chile',
  seoDescription:
    'Arriendo de grúas rough terrain y AT de 100-118 toneladas con operador certificado en Chile. Equipos Grove y Tadano. Hasta 73.57 m de altura. Solicite cotización.',
  catalog: [
    {
    ...
    */
    {
      ...
      capacity: '110 t',
      height: '73.57 m',
      shortDesc: 'Grúa rough terrain ideal para refinerías y espacios reducidos. Capacidad de 110 toneladas con pluma de 56 m y extensiones de hasta 17.7 m. Motor Cummins, contrapeso auto extraíble y sistema de control avanzado con Diagrama Inteligente Tadano.',
      description: 'La Tadano GR-1200XL-3 es una grúa rough terrain de 110 toneladas diseñada especialmente para trabajos en refinerías y espacios confinados. Equipada con motor Cummins, comparte el chasis con las grúas de 90.7 t, lo que le permite operar en los mismos espacios reducidos con la misma extensión de estabilizadores (7.33 m x 7.3 m). Su pluma principal de 56 m es la más larga de su clase, y con extensiones de plumín de 10.1 m o 17.7 m alcanza una altura máxima de cabeza de pluma de 73.57 m. El contrapeso es auto extraíble para facilitar el transporte. Cuenta con el Diagrama Inteligente de Tadano que amplía el área de trabajo y proporciona rendimiento superior con cualquier configuración de estabilizadores. Tiro de línea de elevación de 9,900 kg y radio máximo de 48.46 m. Transmisión 4x4x4 con 2 ejes para máxima maniobrabilidad en terrenos difíciles.',
      features: [
        'Pluma principal de 56 m (la más larga de su clase).',
        'Extensiones de plumín: 10.1 m / 17.7 m.',
        'Altura máxima de cabeza de pluma: 73.57 m.',
        'Motor Cummins con reducción de emisiones.',
        'Contrapeso auto extraíble para transporte fácil.',
        'Diagrama Inteligente Tadano para máximo rendimiento.',
        'Estabilizadores: 7.33 m x 7.3 m (mismo chasis que grúas de 90 t).',
      ],
      specs: [
        { attribute: 'Capacidad máxima', value: '110 t' },
        { attribute: 'Pluma principal', value: '12.0 – 56.0 m' },
        { attribute: 'Extensiones de plumín', value: '10.1 m / 17.7 m' },
        { attribute: 'Altura máxima de cabeza de pluma', value: '73.57 m' },
        { attribute: 'Radio máximo', value: '48.46 m' },
        { attribute: 'Base de estabilizadores', value: '7.33 m x 7.3 m' },
        { attribute: 'Tiro de línea de elevación', value: '9,900 kg' },
        { attribute: 'Motor', value: 'Cummins' },
        { attribute: 'Transmisión', value: '4x4x4' },
        { attribute: 'Ejes', value: '2 ejes' },
        { attribute: 'Dimensiones (L x W x H)', value: '14.45 m x 3.31 m x 3.79 m' },
        { attribute: 'Contrapeso', value: 'Auto extraíble' },
      ],
      image: GRUA_TADANO_GR1200XL,
      gallery: [GRUA_TADANO_GR1200XL, GRUA_TADANO_GR1200XL, GRUA_TADANO_GR1200XL],
      techSheetUrl: 'https://assets.onetadano.com/celum_assets/documents/gr_1200xl3_datasheet_imperial_panam_en.pdf',
      whatsappMessage: 'Hola IP, quisiera cotizar arriendo de Grúa Tadano GR-1200XL-3 (110 t).',
      relatedSlugs: ['grua-tadano-gr1000xl', 'grua-grove-gmk-4100'],
      seoTitle: 'Arriendo de Grúa Tadano GR-1200XL-3 de 110 Toneladas en Chile',
      seoDescription: 'Arriende la grúa rough terrain Tadano GR-1200XL-3 de 110 t con operador certificado. Pluma de 56 m, altura de 73.57 m y motor Cummins. Cotice online.',
    },
    {
      slug: 'grua-tadano-gr1300xl',
      name: 'Tadano GR-1300XL-4',
      brand: 'Tadano',
      capacity: '118 t',
      height: '72.51 m',
      shortDesc: 'Grúa rough terrain con la pluma más larga de su clase: 56 m (6 secciones). Capacidad de 118 toneladas con tecnología Smart Chart, contrapeso auto extraíble y carrier compacto de 8.5 m para fácil transporte.',
      description: 'La Tadano GR-1300XL-4 es una grúa rough terrain de 118 toneladas (130 USt) que destaca por tener la pluma más larga de su clase: 56 m con 6 secciones y sistema de telescoping pinning confiable. Equipada con motor Cummins, ofrece contrapeso auto extraíble y una longitud de carrier compacta de solo 8.5 m sobre un sistema de 2 ejes, lo que facilita su transporte a cualquier faena. Cuenta con la tecnología Smart Chart de Tadano que maximiza el rendimiento de trabajo, estabilizadores asimétricos para mayor flexibilidad en espacios reducidos, cabina inclinable y sistema Eco Mode para ahorrar combustible y mejorar la eficiencia. Su pluma principal de 56 m se extiende con extensiones de 10.3 m o 18.0 m para alcanzar una altura máxima de punta de 72.51 m. Tiro de línea de elevación de 7,200 kg y radio máximo de 62.48 m. Transmisión 4x4x4 con 2 ejes para máxima maniobrabilidad en terrenos difíciles.',
      features: [
        'Pluma de 6 secciones: 12.2 – 56.0 m (la más larga de su clase).',
        'Extensiones de pluma: 10.3 m / 18.0 m.',
        'Altura máxima de punta: 72.51 m.',
        'Motor Cummins con sistema Eco Mode.',
        'Tecnología Smart Chart para máximo rendimiento.',
        'Contrapeso auto extraíble para transporte fácil.',
        'Carrier compacto de 8.5 m sobre 2 ejes.',
        'Estabilizadores asimétricos para espacios reducidos.',
      ],
      specs: [
        { attribute: 'Capacidad máxima', value: '118 t (130 USt)' },
        { attribute: 'Pluma principal', value: '12.2 – 56.0 m (6 secciones)' },
        { attribute: 'Extensiones de pluma', value: '10.3 m / 18.0 m' },
        { attribute: 'Altura máxima de punta', value: '72.51 m' },
        { attribute: 'Radio máximo', value: '62.48 m' },
        { attribute: 'Base de estabilizadores', value: '7.66 m x 7.8 m' },
        { attribute: 'Tiro de línea de elevación', value: '7,200 kg' },
        { attribute: 'Motor', value: 'Cummins' },
        { attribute: 'Transmisión', value: '4x4x4' },
        { attribute: 'Ejes', value: '2 ejes' },
        { attribute: 'Dimensiones (L x W x H)', value: '14.7 m x 2.90 m x 3.95 m' },
        { attribute: 'Longitud de carrier', value: '8.5 m' },
        { attribute: 'Contrapeso', value: 'Auto extraíble' },
      ],
      image: GRUA_TADANO_GR1300XL,
      gallery: [GRUA_TADANO_GR1300XL, GRUA_TADANO_GR1300XL, GRUA_TADANO_GR1300XL],
      techSheetUrl: 'https://mediahub.tadano.com/m/6c04bf8740bd293f/original/doc_tadano_GR-1300XL-4_datasheet_imperial_en.pdf',
      whatsappMessage: 'Hola IP, quisiera cotizar arriendo de Grúa Tadano GR-1300XL-4 (118 t).',
      relatedSlugs: ['grua-tadano-gr1200xl', 'grua-grove-gmk-4100'],
      seoTitle: 'Arriendo de Grúa Tadano GR-1300XL-4 de 118 Toneladas en Chile',
      seoDescription: 'Arriende la grúa rough terrain Tadano GR-1300XL-4 de 118 t con operador certificado. Pluma de 56 m (6 secciones), altura de 72.51 m y tecnología Smart Chart. Cotice online.',
    },
  ],
...
const IZAJE_GRUAS_250: RentalSubcategory = {
  ...
  shortDesc: 'Grúas todo terreno de 250 t para izaje pesado en gran minería, energía e infraestructura.',
  description:
    'Arriendo de grúas de 250 toneladas en Chile para proyectos de gran minería, energía e infraestructura pesada. Grúas todo terreno (AT) de marcas líderes como Grove, con capacidades de 250 toneladas y plumas telescópicas de hasta 78.5 metros (la más larga sobre 5 ejes del mercado), extensible con pluma giratoria hasta 109 metros de altura. Equipos de 5 ejes con motores de alta potencia (530 HP), sistema de suspensión MEGATRAK® y MAXbase™ para máxima estabilidad en terrenos difíciles. Operadores certificados con amplia experiencia en montajes industriales, izaje de equipos de proceso y construcción de gran envergadura. Servicio incluye planes de izaje, permisos de trabajo, supervisión técnica especializada, transporte del equipo y seguros. Disponibilidad en zona norte (Atacama, Coquimbo, Antofagasta) y centro del país, con respuesta operativa en menos de 72 horas.',
  features: [
    'Grúas todo terreno (AT) de 250 toneladas.',
    'Pluma telescópica de hasta 78.5 m + pluma giratoria (109 m total).',
    'Sistema MEGATRAK® y MAXbase™ para máxima estabilidad.',
    'Operadores certificados con experiencia en gran minería.',
  ...
  specs: [
    { label: 'Capacidad', value: '250 t' },
    { label: 'Altura máxima', value: '70 – 109 m' },
    { label: 'Operador', value: 'Incluido' },
    { label: 'Disponibilidad', value: '24/7' },
  ],
  heroImage: IZAJE_HERO,
  bodyImage: GRUA_GROVE_250T,
  bodyImageAlt: 'Grúa Grove GMK5250XL-1 de 250 toneladas en faena minera',
  seoTitle: 'Arriendo de Grúas de 250 Toneladas en Chile',
  seoDescription:
    'Arriendo de grúas todo terreno de 250 toneladas con operador certificado en Chile. Equipos Grove con pluma de hasta 78.5 m y sistema MAXbase™. Solicite cotización.',
  catalog: [
    {
      slug: 'grua-grove-gmk-5250l',
      name: 'Grove GMK5250L-1',
      brand: 'Grove',
      capacity: '250 t',
      height: '110 m',
      shortDesc: 'Grúa todo terreno de 5 ejes con capacidad de 250 t, pluma MEGAFORM® de 7 secciones (70 m) y plumín giratorio de hasta 21.3 m. Motor Mercedes-Benz de 390 kW, sistema MEGATRAK® y MAXbase™ para máxima estabilidad y maniobrabilidad.',
      description: 'La Grove GMK5250L-1 es una grúa todo terreno de 250 toneladas diseñada para operaciones de alto rendimiento en minería, energía e infraestructura pesada. Su pluma MEGAFORM® de 7 secciones alcanza 70 m, y con plumín giratorio de hasta 21.3 m logra alturas de hasta 110 m. Equipada con motor Mercedes-Benz OM471LA de 390 kW (530 HP), transmisión Mercedes G 280-16 y sistema de suspensión MEGATRAK®, ofrece excelente movilidad y estabilidad en terrenos difíciles. El sistema MAXbase™ permite posiciones de estabilizador asimétricas para mayor flexibilidad en espacios reducidos. Con tracción 10x6x10 (opcional 10x8x10), 5 ejes direccionales y contrapeso total de 80 t, es ideal para izajes críticos en proyectos de gran envergadura. Cabina de superestructura inclinable 20° y sistema de control CCS para máxima comodidad y precisión del operador.',
      features: [
        'Pluma MEGAFORM® de 7 secciones: 13.3 – 70 m.',
        'Plumín giratorio: 12.5 m / 21.3 m (opcional).',
        'Motor Mercedes-Benz OM471LA de 390 kW (530 HP).',
        'Sistema de suspensión MEGATRAK® con bloqueo hidráulico.',
        'MAXbase™ para posiciones de estabilizador asimétricas.',
        'Cabina de superestructura inclinable 20°.',
        'Sistema de control CCS (Crane Control System).',
      ],
      specs: [
        { attribute: 'Capacidad máxima', value: '250 t' },
        { attribute: 'Pluma principal', value: '13.3 – 70 m (7 secciones MEGAFORM®)' },
        { attribute: 'Plumín giratorio', value: '12.5 m / 21.3 m (opcional)' },
        { attribute: 'Altura máxima de punta', value: '110 m' },
        { attribute: 'Motor', value: 'Mercedes-Benz OM471LA' },
        { attribute: 'Potencia', value: '390 kW / 530 HP' },
        { attribute: 'Transmisión', value: 'Mercedes G 280-16' },
        { attribute: 'Contrapeso total', value: '80 t' },
        { attribute: 'Peso bruto total', value: '60 t' },
        { attribute: 'Ejes', value: '5 ejes direccionales' },
        { attribute: 'Tracción / Dirección', value: '10x6x10 (opcional 10x8x10)' },
        { attribute: 'Base de estabilizadores', value: '9 m x 7.8 m' },
        { attribute: 'Embrague', value: 'VIAB turbo retardado (opcional)' },
        { attribute: 'Norma de emisiones', value: 'EUROMOT 5 / EPA Tier 4 final' },
      ],
      image: GRUA_GROVE_250T,
      gallery: [GRUA_GROVE_250T, GRUA_GROVE_250T, GRUA_GROVE_250T],
      techSheetUrl: 'https://www.manitowoc.com/es/media/15016/download',
      whatsappMessage: 'Hola IP, quisiera cotizar arriendo de Grúa Grove GMK5250L-1 (250 t).',
      relatedSlugs: ['grua-grove-gmk-4100', 'grua-grove-gmk-5250xl-1'],
      seoTitle: 'Arriendo de Grúa Grove GMK5250L-1 de 250 Toneladas en Chile',
      seoDescription: 'Arriende la grúa todo terreno Grove GMK5250L-1 de 250 t con operador certificado. Pluma MEGAFORM® de 70 m, sistema MAXbase™ y motor Mercedes-Benz. Cotice online.',
    },
    {
      slug: 'grua-grove-gmk-5250xl-1',
      name: 'Grove GMK5250XL-1',
      brand: 'Grove',
      capacity: '250 t',
      height: '109 m',
      shortDesc: 'Grúa todo terreno de 5 ejes con la pluma más larga de su clase: 78.5 m (8 secciones MEGAFORM®). Motor Mercedes-Benz de 390 kW, sistema MEGATRAK®, MAXbase™ y consumo de diésel 30 % menor que la generación anterior.',
      description: 'La Grove GMK5250XL-1 es una grúa todo terreno de 250 toneladas que destaca por tener la pluma más larga sobre 5 ejes del mercado: 78.5 m con 8 secciones MEGAFORM® y TWIN-LOCK®, alcanzando alturas de hasta 109 m con pluma giratoria. Su diseño de motor único con los más recientes niveles de emisión (EUROMOT 5 / EPA Tier 4 final) reduce el consumo de diésel en un 30 % comparado con modelos anteriores. Equipada con motor Mercedes-Benz OM471LA de 390 kW, transmisión Mercedes G 280-16, suspensión MEGATRAK® y sistema MAXbase™ para posiciones de estabilizador asimétricas. Con tracción 10x6x10 (opcional 10x8x10), contrapeso de 80 t y dimensiones compactas (anchura mínima de 2.99 m), ofrece la combinación perfecta de alcance, capacidad y maniobrabilidad para proyectos de gran envergadura en minería, energía e infraestructura.',
      features: [
        'Pluma MEGAFORM® de 8 secciones: 13.4 – 78.5 m (la más larga sobre 5 ejes).',
        'Pluma giratoria: 11.2 m / 17.8 m (opcional).',
        'Motor Mercedes-Benz OM471LA de 390 kW (530 HP) con 30 % menos consumo.',
        'Sistema de suspensión MEGATRAK® con bloqueo hidráulico.',
        'MAXbase™ para posiciones de estabilizador asimétricas.',
        'Cabina de superestructura inclinable 20°.',
        'Sistema de control CCS (Crane Control System).',
      ...
      specs: [
        { attribute: 'Capacidad máxima', value: '250 t' },
        { attribute: 'Pluma principal', value: '13.4 – 78.5 m (8 secciones MEGAFORM®)' },
        { attribute: 'Pluma giratoria', value: '11.2 m / 17.8 m (opcional)' },
        { attribute: 'Altura máxima de punta', value: '109 m' },
        { attribute: 'Motor', value: 'Mercedes-Benz OM471LA' },
        { attribute: 'Potencia', value: '390 kW / 530 HP' },
        { attribute: 'Transmisión', value: 'Mercedes G 280-16' },
        { attribute: 'Contrapeso total', value: '80 t' },
        ...
        { attribute: 'Tracción / Dirección', value: '10x6x10 (opcional 10x8x10)' },
        { attribute: 'Base de estabilizadores', value: '9 m x 7.8 m' },
        { attribute: 'Anchura mínima', value: '2.99 m' },
        { attribute: 'Embrague', value: 'VIAB turbo retardado (opcional)' },
        { attribute: 'Norma de emisiones', value: 'EUROMOT 5 / EPA Tier 4 final' },
      ],
      image: GRUA_GROVE_250T_XL,
      gallery: [GRUA_GROVE_250T_XL, GRUA_GROVE_250T_XL, GRUA_GROVE_250T_XL],
      techSheetUrl: 'https://www.manitowoc.com/es/media/14660/download',
      whatsappMessage: 'Hola IP, quisiera cotizar arriendo de Grúa Grove GMK5250XL-1 (250 t).',
      relatedSlugs: ['grua-grove-gmk-5250l', 'grua-grove-gmk6400'],
      seoTitle: 'Arriendo de Grúa Grove GMK5250XL-1 de 250 Toneladas en Chile',
      seoDescription: 'Arriende la grúa todo terreno Grove GMK5250XL-1 de 250 t con la pluma más larga de su clase (78.5 m). Sistema MAXbase™ y motor Mercedes-Benz. Cotice online.',
    },
   /*  {
...
const IZAJE_GRUAS_160: RentalSubcategory = {
  ...
  shortDesc: 'Grúas todo terreno de 160 t para izaje pesado en minería, energía e infraestructura.',
  description:
    'Arriendo de grúas de 160 toneladas en Chile para proyectos de gran minería, energía e infraestructura pesada. Grúas todo terreno (AT) de marcas líderes como Demag, con capacidades de 160 toneladas y pluma telescópica de hasta 68 metros, extensible con jib plegable hasta 80 metros de altura. Equipos de 5 ejes con motores de alta potencia (500 HP), transmisión automática y velocidad de traslado de hasta 85 km/h para rápida movilización entre faenas. Operadores certificados con amplia experiencia en montajes industriales, izaje de equipos de proceso y construcción de gran envergadura. Servicio incluye planes de izaje, permisos de trabajo, supervisión técnica especializada, transporte del equipo y seguros. Disponibilidad en zona norte (Atacama, Coquimbo, Antofagasta) y centro del país, con respuesta operativa en menos de 72 horas.',
  features: [
    'Grúas todo terreno (AT) de 160 toneladas.',
    'Pluma telescópica de hasta 68 m + jib plegable (80 m total).',
    'Operadores certificados con experiencia en gran minería.',
    'Planes de izaje, permisos de trabajo y supervisión técnica especializada.',
    'Transporte del equipo y montaje en faena incluido.',
    'Disponibilidad 24/7 y seguros de alto tonelaje.',
  ...
  specs: [
    { label: 'Capacidad', value: '160 t' },
    { label: 'Altura máxima', value: '68 – 80 m' },
    { label: 'Operador', value: 'Incluido' },
    { label: 'Disponibilidad', value: '24/7' },
  ],
  heroImage: IZAJE_HERO,
  bodyImage: GRUA_DEMAG_160T,
  bodyImageAlt: 'Grúa Demag AC 160-5 de 160 toneladas en faena',
  seoTitle: 'Arriendo de Grúas de 160 Toneladas en Chile',
  seoDescription:
    'Arriendo de grúas todo terreno de 160 toneladas con operador certificado en Chile. Equipos Demag con pluma de 68 m y jib plegable. Solicite cotización.',
  catalog: [
    {
      ...
      capacity: '160 t',
      height: '80 m',
      shortDesc: 'Grúa todo terreno de 160 t con pluma telescópica de 7 secciones de 12.4 a 68 m y jib plegable de 11/21 m. Motor Scania DC13 de 500 HP, transmisión ZF AS-Tronic y 5 ejes para máxima movilidad en carretera y faena.',
      description: 'La Demag AC 160-5 es una grúa todo terreno de 160 toneladas diseñada para operaciones de izaje pesado en minería, energía e infraestructura. Su pluma telescópica de 7 secciones alcanza 68 m, y con el jib plegable de 11/21 m (desplazable a 0°, 20° y 40°) logra alturas de hasta 80 m. Equipada con motor Scania DC13 de 6 cilindros y 500 HP (368 kW), transmisión automática ZF AS-Tronic de 12+2 velocidades y velocidad máxima de 85 km/h, ofrece excelente movilidad en carretera y rendimiento en faena. Sistema de tracción 10x6x10 (opcional 10x8x10) con 5 ejes direccionales, contrapeso de 46 t y estabilizadores con base de 8.14 x 7.50 m (reducible a 8.14 x 5.30 m). Velocidad de línea de 120 m/min y tiro de 98.2 kN para operaciones eficientes. Ideal para montajes industriales, izaje de equipos de proceso y construcción de gran envergadura.',
      features: [
        'Pluma telescópica de 7 secciones: 12.4 – 68 m.',
        'Jib plegable de 11/21 m (desplazable 0°/20°/40°).',
        'Motor Scania DC13 de 500 HP (Tier 4F).',
        'Transmisión ZF AS-Tronic de 12+2 velocidades.',
        '5 ejes con tracción 10x6x10 (opcional 10x8x10).',
        'Contrapeso de 46 t para máxima estabilidad.',
        'Velocidad de línea: 120 m/min, tiro: 98.2 kN.',
      ],
      specs: [
        { attribute: 'Capacidad máxima', value: '160 t @ 3 m de radio' },
        { attribute: 'Pluma telescópica', value: '12.4 – 68 m (7 secciones)' },
        { attribute: 'Jib plegable', value: '11 / 21 m (0°/20°/40°)' },
        { attribute: 'Altura máxima de punta', value: '~80 m (con jib)' },
        { attribute: 'Motor', value: 'Scania DC13, 6 cil. turbo' },
        { attribute: 'Potencia', value: '368 kW / 500 HP' },
        { attribute: 'Torque máximo', value: '2373 Nm @ 1300 rpm' },
        { attribute: 'Transmisión', value: 'ZF AS-Tronic 12+2 velocidades' },
        { attribute: 'Velocidad máxima', value: '85 km/h' },
        { attribute: 'Contrapeso', value: '46 t' },
        { attribute: 'Peso bruto total', value: '60 t' },
        { attribute: 'Ejes', value: '5 ejes direccionales' },
        { attribute: 'Tracción / Dirección', value: '10x6x10 (opcional 10x8x10)' },
        { attribute: 'Base de estabilizadores', value: '8.14 x 7.50 m (reducible a 5.30 m)' },
        { attribute: 'Velocidad de línea', value: '120 m/min' },
        { attribute: 'Tiro de línea', value: '98.2 kN' },
        { attribute: 'Neumáticos', value: '385/95 R25 (opcional 445/95 R25 / 525/80)' },
      ],
      image: GRUA_DEMAG_160T,
      gallery: [GRUA_DEMAG_160T, GRUA_DEMAG_160T, GRUA_DEMAG_160T],
      // TODO: techSheetUrl pendiente - sitio de referencia (lectura-specs.es) requiere suscripción
      // techSheetUrl: 'https://www.lectura-specs.es/es/modelo/gruas/gruas-todo-terreno-demag/ac-160-5-11686431',
      whatsappMessage: 'Hola IP, quisiera cotizar arriendo de Grúa Demag AC 160-5 (160 t).',
      relatedSlugs: ['grua-grove-gmk-4100', 'grua-grove-gmk6400'],
      seoTitle: 'Arriendo de Grúa Demag AC 160-5 de 160 Toneladas en Chile',
      seoDescription: 'Arriende la grúa todo terreno Demag AC 160-5 de 160 t con operador certificado. Pluma de 68 m, jib plegable y motor Scania de 500 HP. Cotice online.',
    },
  ],
...
const IZAJE_GRUAS_400: RentalSubcategory = {
  ...
  shortDesc: 'Grúas todo terreno de 400 t para izaje pesado en gran minería, energía e infraestructura.',
  description:
    'Arriendo de grúas de 400 toneladas en Chile para proyectos de gran minería, energía e infraestructura pesada. Equipos hidráulicos todo terreno (AT) de marcas líderes como Grove, con capacidades entre 350 y 450 toneladas y altura máxima de pluma de hasta 136 metros con plumín y accesorios especiales. Operadores certificados con amplia experiencia en faenas mineras y montajes industriales. Servicio incluye planes de izaje, permisos de trabajo, supervisión técnica especializada, transporte del equipo y seguros. Disponibilidad en zona norte (Atacama, Coquimbo, Antofagasta) y centro del país, con respuesta operativa en menos de 72 horas por la complejidad logística de estos equipos.',
  features: [
    'Grúas hidráulicas todo terreno (AT) de 350 a 450 toneladas.',
    'Operadores certificados con amplia experiencia en gran minería.',
    'Planes de izaje, permisos de trabajo y supervisión técnica especializada.',
    'Transporte del equipo y montaje en faena incluido.',
    'Disponibilidad 24/7 y seguros de alto tonelaje.',
  ],
  specs: [
    { label: 'Capacidad', value: '350 – 450 t' },
    { label: 'Altura máxima', value: '120 – 136 m' },
    { label: 'Operador', value: 'Incluido' },
    { label: 'Disponibilidad', value: '24/7' },
  ],
  heroImage: IZAJE_HERO,
  bodyImage: GRUA_GROVE_400T,
  bodyImageAlt: 'Grúa Grove GMK6400 de 400 toneladas en faena',
  seoTitle: 'Arriendo de Grúas de 400 Toneladas en Chile',
  seoDescription:
    'Arriendo de grúas de 400 toneladas con operador certificado en Chile. Equipos Grove de alto tonelaje. Hasta 136 m de altura. Solicite cotización.',
  catalog: [
    {
      ...
      capacity: '400 t',
      height: '136 m',
      shortDesc: 'Grúa todo terreno de 400 t con la mejor tabla de carga de su clase. Pluma MEGAFORM™ de 60 m, sistema MegaWingLift™ que eleva la capacidad en un 70 % y motor Mercedes-Benz de 551 HP.',
      description: 'La Grove GMK6400 es una grúa todo terreno de 400 toneladas reconocida como la grúa de 6 ejes más potente del mercado. Su pluma principal MEGAFORM™ de 5 secciones alcanza 60 m, y con el accesorio patentado MegaWingLift™ la capacidad de izaje se incrementa en casi un 70 %, permitiendo maniobras que normalmente requerirían una grúa de mayor tonelaje. Equipada con motor Mercedes-Benz OM 502 LA de 8 cilindros y 551 HP, transmisión automática ZF AS Tronic de 12 velocidades, suspensión MEGATRAK™ con MegaDrive™ para tracción integral en terrenos difíciles, y cabina con pantalla gráfica EKS5. Su caja de estabilizadores desmontables (ROB) y contrapeso modular de 135 t facilitan el transporte y montaje en faena. Ganadora del premio ESTA a la Innovación 2013.',
      features: [
        'MegaWingLift™: eleva la capacidad de izaje en casi un 70 %.',
        'Pluma MEGAFORM™ de 5 secciones y 60 m con TWIN-LOCK™.',
        'Motor Mercedes-Benz OM 502 LA de 551 HP (Tier 4i).',
        'Suspensión MEGATRAK™ con MegaDrive™ para terrenos difíciles.',
        'Caja de estabilizadores desmontables (ROB) para transporte rápido.',
      ],
      specs: [
        { attribute: 'Capacidad máxima', value: '400 t' },
        { attribute: 'Pluma principal', value: '15,4 – 60 m (5 secciones)' },
        { attribute: 'Plumín / Luffing jib', value: '25 – 79 m' },
        { attribute: 'Altura máxima de punta', value: '136 m' },
        { attribute: 'Motor', value: 'Mercedes-Benz OM 502 LA 8 cil. turbo' },
        { attribute: 'Potencia', value: '405 kW / 551 HP' },
        { attribute: 'Transmisión', value: 'ZF AS Tronic automática 12 vel.' },
        { attribute: 'Contrapeso', value: '135 t' },
        { attribute: 'Peso bruto total', value: '72 t' },
        { attribute: 'Ejes', value: '6 ejes direccionales' },
        { attribute: 'Estabilizadores', value: '5 posiciones' },
      ],
      image: GRUA_GROVE_400T,
      gallery: [GRUA_GROVE_400T, GRUA_GROVE_400T, GRUA_GROVE_400T],
      techSheetUrl: 'https://www.manitowoc.com/es/media/15018/download',
      whatsappMessage: 'Hola IP, quisiera cotizar arriendo de Grúa Grove GMK6400 (400 t).',
      relatedSlugs: ['grua-grove-gmk-5250l', 'grua-grove-gmk-5250xl-1'],
      seoTitle: 'Arriendo de Grúa Grove GMK6400 de 400 Toneladas en Chile',
      seoDescription: 'Arriende la grúa todo terreno Grove GMK6400 de 400 t con operador certificado. Pluma de 60 m, altura máxima de 136 m y sistema MegaWingLift™. Cotice online.',
    },
  ],
...
export const RENTAL_CATEGORIES: RentalCategory[] = [
  {
    ...
    subcategories: [
      ...
      IZAJE_ALZA_HOMBRE,
      IZAJE_MANIPULADORES_TELESCOPICOS,

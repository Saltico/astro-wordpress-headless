...
// Fuente: División político-administrativa de Chile (SUBDERE).
...
/** Lista completa de regiones de Chile con sus comunas. */
export const CHILEAN_REGIONS: ChileanRegion[] = [
  ...
  },
  {
    code: 'VS',
    name: 'Valparaíso',
    communes: ['Algarrobo', 'Cabildo', 'Calera', 'Calle Larga', 'Cartagena', 'Casablanca', 'Catemu', 'Concón', 'El Quisco', 'El Tabo', 'Hijuelas', 'Isla de Pascua', 'Juan Fernández', 'La Cruz', 'La Ligua', 'Limache', 'Llaillay', 'Los Andes', 'Nogales', 'Olmué', 'Panquehue', 'Papudo', 'Petorca', 'Puchuncaví', 'Putaendo', 'Quillota', 'Quilpué', 'Quintero', 'Rinconada', 'San Antonio', 'San Esteban', 'San Felipe', 'Santa María', 'Valparaíso', 'Villa Alemana', 'Viña del Mar', 'Zapallar'],
  },
  {
    code: 'RM',
  ...
  },
  {
    code: 'NB',
    name: 'Ñuble',
    communes: ['Bulnes', 'Cobquecura', 'Coelemu', 'Coihueco', 'Chillán', 'Chillán Viejo', 'El Carmen', 'Ninhue', 'Ñiquén', 'Pemuco', 'Pinto', 'Portezuelo', 'Quillón', 'Quirihue', 'Ránquil', 'San Carlos', 'San Fabián', 'San Ignacio', 'San Nicolás', 'Treguaco', 'Yungay'],
  },
  {
    code: 'BI',
    name: 'Biobío',
    communes: ['Alto Biobío', 'Antuco', 'Arauco', 'Benavente', 'Cabrero', 'Cañete', 'Chiguayante', 'Concepción', 'Contulmo', 'Coronel', 'Curanilahue', 'Florida', 'Hualpén', 'Hualqui', 'Laja', 'Lebu', 'Los Álamos', 'Los Ángeles', 'Lota', 'Mulchén', 'Nacimiento', 'Negrete', 'Penco', 'Quilaco', 'Quilleco', 'San Pedro de la Paz', 'San Rosendo', 'Santa Juana', 'Talcahuano', 'Tirúa', 'Tomé', 'Tucapel', 'Yumbel'],
  },
  {
    code: 'AR',
    name: 'La Araucanía',
...
export function getRegions(): ChileanRegion[] {
  return CHILEAN_REGIONS;
}

/** Retorna las comunas de una región por su código. */
export function getCommunesByRegionCode(regionCode: string): string[] {
  const region = CHILEAN_REGIONS.find((r) => r.code === regionCode);
  return region ? region.communes : [];
}

/** Retorna una región por su código. */
export function getRegionByCode(code: string): ChileanRegion | undefined {
